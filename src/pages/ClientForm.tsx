...
const CONVERSION_FIELDS: { key: keyof ClientFormData; label: string; type?: string; placeholder?: string; required?: boolean; multiline?: boolean }[] = [
  { key: "company_name", label: "Nom de l'entreprise", placeholder: "Ex: Garage Payet Auto", required: true },
  { key: "activity_type", label: "Votre activité", placeholder: "Ex: Mécanique toutes marques à Sainte-Clotilde", required: true },
  { key: "slogan", label: "Phrase d'accroche (optionnel)", placeholder: "Ex: Gardez votre voiture en pleine forme" },
  { key: "main_offer", label: "L'offre à mettre en avant", placeholder: "Ex: Devis gratuit en 2 h sur WhatsApp, remises ce mois-ci", multiline: true, required: true },
  { key: "service_list", label: "Vos prestations avec tarifs", placeholder: "Ex: Vidange dès 79 €, Freins dès 149 €, Distribution dès 390 €...", multiline: true, required: true },
  { key: "usp", label: "Pourquoi vous choisir ?", placeholder: "Ex: Prix affichés, garantie 12 mois, toutes marques", multiline: true },
  { key: "promo_offer", label: "Promotion ou jeu en cours (optionnel)", placeholder: "Ex: -30 % sur le forfait entretien ce mois-ci" },
  { key: "address", label: "Adresse", placeholder: "112 rue Léopold Rambaud, 97490 Sainte-Clotilde", required: true },
  { key: "service_area", label: "Zone d'intervention", placeholder: "Ex: Sainte-Clotilde, Saint-Denis et alentours" },
  { key: "opening_hours", label: "Horaires d'ouverture", placeholder: "Lun–Ven 7h30–17h30, Sam 8h–12h" },
  { key: "contact_phone", label: "Téléphone à afficher", placeholder: "0262 XX XX XX", required: true },
  { key: "whatsapp_number", label: "Numéro WhatsApp (recommandé)", placeholder: "+262692XXXXXX" },
  { key: "cta_preference", label: "Action principale du visiteur", placeholder: "Ex: Envoyer une photo sur WhatsApp pour un devis" },
  { key: "google_reviews_url", label: "Lien vers vos avis Google (optionnel)", placeholder: "https://g.page/..." },
  { key: "photos_note", label: "Photos que vous pouvez nous fournir", placeholder: "Ex: atelier, équipe, réalisations avant/après", multiline: true },
  { key: "notes", label: "Autre chose à nous préciser ?", placeholder: "Tout ce qui vous semble utile", multiline: true },
];
