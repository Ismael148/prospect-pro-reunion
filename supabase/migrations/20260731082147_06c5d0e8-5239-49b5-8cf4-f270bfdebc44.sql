...
BEGIN
  ...
  WHERE c.support_token::text = p_token
  LIMIT 1;
...
GRANT EXECUTE ON FUNCTION public.create_support_ticket_public(text, text, text, text, text, text[]) TO anon, authenticated, service_role;